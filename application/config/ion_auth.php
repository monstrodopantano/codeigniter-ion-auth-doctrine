...
/*
| -------------------------------------------------------------------------
| Persist in Database Type
| -------------------------------------------------------------------------
| If set to TRUE, Ion Auth will use Doctrine for persist as its database backend.
|
| The Doctrine Project is the home to several PHP libraries primarily focused on database storage and object mapping.
| Are external dependencies for to bewith your project:
|   CodeIgniter - Doctrine - http://www.doctrine-project.org
*/
$config['use_doctrine'] = TRUE;
...
|
| [NOTE: If Used ORM Doctrine] 
|    Not recommended changing the name of the tables since there is a mapping done.
|    If you want to rename the tables will have to re-create the entities and their mappings as standard doctrine in the folder:
|    model/entities.
*/
